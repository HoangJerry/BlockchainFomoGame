...
contract DiceGame {
    ...
    constructor (address[3] _contract)
        public
    {
    ...
    function betByEth(bool _method,uint256 _prediction) public payable registered() returns(History){
        History memory _history;
    ...
    function betByToken(bool _method,uint256 _prediction, uint256 _value) public registered() returns(History){
        History memory _history;
        address _sender = msg.sender;
